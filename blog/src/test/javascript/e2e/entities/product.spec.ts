...
describe('Product e2e test', () => {
    ...
    it('should load Products', () => {
        ...
        expect(productComponentsPage.getTitle()).toMatch(/blogApp.product.home.title/);
    ...
    it('should load create Product dialog', () => {
        ...
        expect(productDialogPage.getModalTitle()).toMatch(/blogApp.product.home.createOrEditLabel/);
